      ...
      <div
        className={cn(
          ...
          density === "ultra-compact" &&
            "gap-2 py-1 px-2 border-b border-slate-700/50 bg-transparent rounded-none cursor-pointer"
        )}
            ...
            <Button
              ...
              className={cn(
                ...
                density !== "comfortable"
                  ...
                  : "h-8 text-xs" // Make it icon-only in compact modes? Requirement says Actions: Icon-only buttons.
              )}
              onClick={(e) => {
                e.stopPropagation();
                handleStatusClick();
