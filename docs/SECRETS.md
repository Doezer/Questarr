...
| `STEAM_API_KEY`                         | Steam achievements on the Playing page                        | No — env-only; without it the achievements section is simply hidden (`server/config.ts`, `GET /api/settings/steam`)                                                                                                           |
