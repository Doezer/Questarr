...
| GET    | `/api/indexers/search`         | JWT optional (`optionalAuthenticateToken`) + `sanitizeIndexerSearchQuery`, `validateRequest`                                   | Query: `query` (1–200, required), `category?`/`cat?` (≤500), `limit?` (1–100), `offset?` (≥0), `gameId?`                                                | `{ items, total, offset, blacklistedCount?, errors? }`                          |
...
| GET    | `/api/search`                  | JWT optional (`optionalAuthenticateToken`) + `sanitizeIndexerSearchQuery`, `validateRequest` (alias of `/api/indexers/search`) | Same as `/api/indexers/search`                                                                                                                          | Same as `/api/indexers/search`                                                  |
