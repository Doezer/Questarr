...
| POST   | `/api/downloaders/:id/downloads`                     | JWT + `sensitiveEndpointLimiter`, `sanitizeDownloaderDownloadData`, `validateRequest` | `{ url, title, category?, downloadPath?, priority?, downloadType?, password? }`                                                                                                                                                                           | Add-download result; 404 downloader not found; 400 if downloader disabled       |
