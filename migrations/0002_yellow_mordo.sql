...
--> statement-breakpoint
INSERT INTO `__new_games`("id", "user_id", "igdb_id", "steam_appid", "title", "summary", "cover_url", "release_date", "rating", "platforms", "genres", "publishers", "developers", "screenshots", "status", "original_release_date", "release_status", "hidden", "added_at", "completed_at") SELECT "id", "user_id", "igdb_id", NULL, "title", "summary", "cover_url", "release_date", "rating", "platforms", "genres", "publishers", "developers", "screenshots", "status", "original_release_date", "release_status", "hidden", "added_at", "completed_at" FROM `games`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_user_settings`("id", "user_id", "auto_search_enabled", "auto_download_enabled", "notify_multiple_downloads", "notify_updates", "search_interval_hours", "igdb_rate_limit_per_second", "download_rules", "last_auto_search", "xrel_scene_releases", "xrel_p2p_releases", "steam_sync_failures", "updated_at") SELECT "id", "user_id", "auto_search_enabled", "auto_download_enabled", "notify_multiple_downloads", "notify_updates", "search_interval_hours", "igdb_rate_limit_per_second", "download_rules", "last_auto_search", "xrel_scene_releases", "xrel_p2p_releases", 0, "updated_at" FROM `user_settings`;--> statement-breakpoint
